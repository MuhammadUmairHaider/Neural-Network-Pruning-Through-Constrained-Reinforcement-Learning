...
class MaskedConv2d(nn.modules.conv._ConvNd):
    def __init__(self, in_c, out_c, kernel_size, stride=1, padding=0,
                 ...
                 init_scheme=nn.init.xavier_normal_):
        ...
        super(MaskedConv2d, self).__init__(in_c, out_c, kernel_size, stride,
    ...
    def forward(self, x):
        if self.padding_mode == 'circular':
            ...
            return F.conv2d(F.pad(x, expanded_padding, mode='circular'),
                            self.weight * self.mask, self.bias, self.stride,
