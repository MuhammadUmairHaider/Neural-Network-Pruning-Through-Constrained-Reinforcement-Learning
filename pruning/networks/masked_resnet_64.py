...
from pruning.networks.base_model import BaseModel
from pruning.networks.masked_modules import MaskedLinear, MaskedConv2d
...
def MaskedResNet18_64(*args, **kwargs):
    return MaskedResNet_64(BasicBlock, [2, 2, 2, 2])

def MaskedResNet34_64(*args, **kwargs):
    return MaskedResNet_64(BasicBlock, [3, 4, 6, 3])

def MaskedResNet50_64(*args, **kwargs):
    return MaskedResNet_64(Bottleneck, [3, 4, 6, 3])

def MaskedResNet101_64(*args, **kwargs):
    return MaskedResNet_64(Bottleneck, [3, 4, 23, 3])

def MaskedResNet152_64(*args, **kwargs):
